...
<div class="main-header">
    <h1>📘 TRỢ LÝ SOẠN GIÁO ÁN TỰ ĐỘNG LỚP 2 CÔ NHÀN (NLS)</h1>
    <p>Tác giả: NGUYỄN THỊ NHÀN - Trường PTDTBT Tiểu học Mậu Long - ĐT: 097 4109 364</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Nhàn - Trường PTDTBT Tiểu học Mậu Long </div>", unsafe_allow_html=True)
